...
public class StartFromMiddle extends CommandGroup {
    ...
    public StartFromMiddle() {
    	...
    	// This first if statement goes to whichever side of the switch is ours and dumps the cube
    	if (message.substring(0, 0) == "L") {
    		...
    		// Check to see if scale is on our side. If not, we pile cubes on the switch
